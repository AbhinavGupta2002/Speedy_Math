...
class DivisionViewController: UIViewController {
    ...
    @IBOutlet weak var div_sign: UILabel!
    ...
    func printQuestion() {
        ...
        if (question_count <= 10) {
            ...
            var temp2:Int = Int.random(in: -100...100)
            while (temp2 == 0) {
    ...
    func wrongAnswer() {
        ...
        final_score.isHidden = false
        correct_answer.text = "ANSWER: \(temp_div)"
