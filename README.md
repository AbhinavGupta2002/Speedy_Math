...
Speedy Math is a self developed iOS application that is intended for young children to have fun while practicing their arithemtic skills - addition, subtraction, multiplication, and division. The app has a colorful and user-friendly interface.
