...
extension UITextField {
    ...
    func addNumericAccessory(addMinus: Bool) {
        ...
        if addMinus {
            accessories.append(UIBarButtonItem(title: "-", style: UIBarButtonItem.Style.plain, target: self, action: #selector(MinusPressed)))
...
class AdditionViewController: UIViewController {
    ...
    @IBOutlet weak var plus_sign: UILabel!
    ...
    func printQuestion() {
        ...
        if (question_count <= 10) {
            ...
            let temp1 = Int.random(in: 0...500)
            let temp2 = Int.random(in: 0...500)
    ...
    func wrongAnswer() {
        ...
        final_score.isHidden = false
        correct_answer.text = "ANSWER: \(temp_sum)"
